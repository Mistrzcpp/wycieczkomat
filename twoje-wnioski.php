...
<main class="d-flex justify-content-center m-0 align-items-center flex-column">
    <div class="col-7 shadow rounded my-5" id="searchDiv">
    ...
    <div class="shadow rounded col-9 row py-3 mx-2 justify-content-center" id="searchResults">
    </div>
</main>

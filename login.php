<?php
    ...
    //stanowiska
    $stmt = $conn -> prepare("SELECT u.imie, u.nazwisko, s.nazwa FROM przypisane_stanowiska ps JOIN stanowiska s ON ps.stanowisko_id=s.id JOIN uzytkownicy u ON ps.uzytkownik_id=u.id WHERE uzytkownik_id=:id;");
    ...
    $_SESSION['surname'] = $result[0]['nazwisko'];    
